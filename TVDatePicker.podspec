...
Pod::Spec.new do |s|
  s.name             = 'TVDatePicker'
  s.version          = '0.1.0'
  s.summary          = 'A short description of TVDatePicker.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Kevin Bradley/TVDatePicker'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Kevin Bradley' => 'kevin.w.bradley@me.com' }
  s.source           = { :git => 'https://github.com/Kevin Bradley/TVDatePicker.git', :tag => s.version.to_s }
